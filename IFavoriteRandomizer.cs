...
namespace TimeTableManager {
	...
	public interface IFavoriteRandomizer {
        ...
        void AutoAllwithChief (BTimeTable table, DateTime Adate);
        /// <summary>自動設定する
        /// </summary>
        /// <param name="table">設定するタイムテーブル</param>
        /// <param name="start">開始</param>
        /// <param name="end">終了</param>
		void  AutoAllwithChief(BTimeTable table, DateTime start, DateTime end);
        /// <summary>自動設定する
        /// </summary>
        /// <param name="table">設定するタイムテーブル</param>
        ...
        /// <param name="start">開始</param>
        /// <param name="end">終了</param>
        void AutoAllwithChief (BTimeTable table, DateTime today, DateTime start, DateTime end);
	}
}